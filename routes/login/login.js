    ...
    try {
        ...
        if (isMatch) {
            ...
            if (user.role == "LabHead") {
                ...
                res.redirect('/user/pilabheadRecords?page=1&limit=6&id='+user._id);
            }
            if (user.role == "Tester") {
                res.redirect('/user/tester?page=1&limit=6&id='+user._id);
            }
            if (user.role == "Finance") {
                res.redirect('/user/dataOfItLab?page=1&limit=6&id='+user._id);
            }
        } else {
